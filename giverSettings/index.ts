...
export class itgoldWallet implements Giver {
  public giverContract: Contract<typeof itgoldWalletAbi>;

  constructor(ever: ProviderRpcClient, readonly keyPair: Ed25519KeyPair, address: string) {
    const giverAddr = new Address(address);
    this.giverContract = new ever.Contract(itgoldWalletAbi, giverAddr);
  }
