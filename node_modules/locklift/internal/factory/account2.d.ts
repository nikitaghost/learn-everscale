...
import { SimpleAccountsStorage, Account } from "everscale-standalone-client/nodejs";
declare type CreateAccountParams<T extends FactoryType> = {
...
declare type AddExistingAccountParams = {
