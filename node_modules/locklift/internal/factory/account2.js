...
class AccountFactory2 {
    ...
    createAccount = async (params) => {
        switch (params.type) {
            ...
            case types_1.WalletTypes.MsigAccount: {
                ...
                const account = new nodejs_1.MsigAccount({ publicKey: params.publicKey, address: contractWithTx.contract.address });
    ...
    getExistingAccount = async (params) => {
        switch (params.type) {
            ...
            case types_1.WalletTypes.MsigAccount:
                return new nodejs_1.MsigAccount({ publicKey: params.publicKey, address: params.address });
        }
    };
    /*
