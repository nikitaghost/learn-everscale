...
exports.getErrorsInfo = exports.getBalanceDiff = exports.getBalanceChangingInfo = exports.printer = exports.calculateTotalFees = exports.applyTotalFees = exports.colors = exports.mapType = void 0;
...
const printer = ({ type, decodedMsg, contract, totalFees, sentValue, value, balanceChange, error, }, { contracts }) => {
    ...
    const header = `${type && exports.mapType[type]}${error ? ` ERROR (phase: ${error.phase}, code: ${error.code})` : ""} ${exports.colors.contractName(contract.name)}.${exports.colors.methodName(decodedMsg?.method)}${type === types_1.TraceType.EVENT ? "" : valueParams}`;
    const printMsg = `${header}(${Object.entries((0, mappers_1.mapParams)(decodedMsg?.params, contracts))
